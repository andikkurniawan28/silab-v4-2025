...
class AnalisaAmpasMetodeDinginController extends Controller
{
    ...
    public function create(){
        ...
        $materials = ParameterMaterial::select(['material_id'])->where('parameter_id', 9)->where('is_verified', 0)->get();
        $samples = Analysis::whereIn('material_id', $materials)->select(['id', 'p3 as pol', 'p7 as kadar_air'])->whereNull('p9')->get();
