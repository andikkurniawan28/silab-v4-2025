...
@section('varieties-show', 'show')

@section('content')
<div class="container-fluid py-0 px-0">
    <h1 class="h3 mb-3"><strong>Daftar Varietas Tebu</strong></h1>

    @if(Auth()->user()->role->akses_tambah_varietas_tebu)
    <div class="d-flex justify-content-between align-roles-center mb-3">
        <a href="{{ route('varieties.create') }}" class="btn btn-primary">
