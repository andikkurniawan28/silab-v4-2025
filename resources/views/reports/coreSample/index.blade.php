...
@section('laporan_core_sample-active', 'active')
...
@section('content')
    <div class="container-fluid py-0 px-0">
        ...
        <h1 class="h3 mb-4"><strong>Laporan Core Sample</strong></h1>

        {{-- Form filter --}}
        <div class="card shadow-sm mb-4">
            <div class="card-body">
                <form id="coreSampleForm">
    ...
    <script>
        document.getElementById('coreSampleForm').addEventListener('submit', function(e) {
            e.preventDefault();
            ...
            let url = "{{ route('reports.coreSample.data', ['date' => ':date', 'shift' => ':shift']) }}";
...
<div class="card shadow-sm">
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table id="coreSampleTable" class="table table-bordered table-hover table-striped text-left text-dark">
                ...
                <tbody>${tableRows}</tbody>
                    ...
                    document.getElementById('btnExportExcel').addEventListener('click', function() {
                        ...
                        let ws = XLSX.utils.table_to_sheet(document.getElementById('coreSampleTable'));
                        XLSX.utils.book_append_sheet(wb, ws, "Laporan Core Sample");
                    ...
                    document.getElementById('btnExportPDF').addEventListener('click', function() {
                        ...
                        doc.setFontSize(14);
                        doc.text("Laporan Core Sample", 40, 30);
                        doc.setFontSize(10);
                        doc.text(`Tanggal: ${date} | Shift: ${shift}`, 40, 50);

                        doc.autoTable({
                            html: '#coreSampleTable',
                            startY: 70,
                            theme: 'grid',
                            headStyles: {
