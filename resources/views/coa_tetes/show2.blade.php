...
<body bgcolor="#A0A0A0" vlink="blue" link="blue">
    <div id="page1-div" style="position:relative;width:892px;height:1263px;">
        <img width="892" height="1263" src="/admin_template/img/coa_tetes_3_tangki.png" alt="background image" />
        ...
        <p style="position:absolute;top:350px;left:248px;white-space:nowrap" class="ft15">
            :&#160;{{ date("d", strtotime($request->date)) }}&#160;{{ $bulan_indonesia[date("m", strtotime($request->date))] }}&#160;{{ date("Y", strtotime($request->date)) }}&#160;</p>
        ...
        <p style="position:absolute;top:570px;left:422px;white-space:nowrap" class="ft15">@if($samples[0]->brixw != NULL) {{ number_format($samples[0]->brixw, 2) }} @endif&#160;</p>
        <p style="position:absolute;top:570px;left:524px;white-space:nowrap" class="ft15">@if($samples[1]->brixw != NULL) {{ number_format($samples[1]->brixw, 2) }} @endif&#160;</p>
        <p style="position:absolute;top:570px;left:623px;white-space:nowrap" class="ft15">@if($samples[2]->brixw != NULL) {{ number_format($samples[2]->brixw, 2) }} @endif&#160;</p>
        ...
        <p style="position:absolute;top:591px;left:524px;white-space:nowrap" class="ft15">@if($samples[1]->tsai != NULL) {{ number_format($samples[1]->tsai, 2) }} @endif&#160;</p>
        <p style="position:absolute;top:591px;left:623px;white-space:nowrap" class="ft15">@if($samples[2]->tsai != NULL) {{ number_format($samples[2]->tsai, 2) }} @endif&#160;</p>
        ...
        <p style="position:absolute;top:612px;left:419px;white-space:nowrap" class="ft15">@if($samples[0]->od != NULL) {{ number_format($samples[0]->od, 2) }} @endif&#160;</p>
        <p style="position:absolute;top:612px;left:520px;white-space:nowrap" class="ft15">@if($samples[1]->od != NULL) {{ number_format($samples[1]->od, 2) }} @endif&#160;</p>
        <p style="position:absolute;top:612px;left:618px;white-space:nowrap" class="ft15">@if($samples[2]->od != NULL) {{ number_format($samples[2]->od, 2) }} @endif&#160;</p>
