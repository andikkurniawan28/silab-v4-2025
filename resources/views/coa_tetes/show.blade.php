...
<body bgcolor="#A0A0A0" vlink="blue" link="blue">
    <div id="page1-div" style="position:relative;width:892px;height:1263px;">
        <img width="892" height="1263" src="/Silab-V3/public/admin_template/img/coa_tetes_2_tangki.png" alt="background image" />
        ...
        <p style="position:absolute;top:350px;left:248px;white-space:nowrap" class="ft15">
            :&#160;{{ date("d", strtotime($request->created_at)) }}&#160;{{ $bulan_indonesia[date("m", strtotime($request->created_at))] }}&#160;{{ date("Y", strtotime($request->created_at)) }}&#160;</p>
        ...
        <p style="position:absolute;top:510px;left:437px;white-space:nowrap" class="ft16">
            <b>Hasil&#160;Pengujian&#160;</b></p>
        <p style="position:absolute;top:530px;left:462px;white-space:nowrap" class="ft17">
            <i>Test&#160;Results&#160;</i></p>
        <p style="position:absolute;top:510px;left:674px;white-space:nowrap" class="ft16"><b>Metode&#160;</b></p>
        <p style="position:absolute;top:530px;left:680px;white-space:nowrap" class="ft17"><i>Method&#160;</i></p>
        <p style="position:absolute;top:549px;left:407px;white-space:nowrap" class="ft16"><b>Tangki&#160;1&#160;</b>
        </p>
        <p style="position:absolute;top:549px;left:515px;white-space:nowrap" class="ft16"><b>Tangki&#160;2&#160;</b>
        </p>
        ...
        <p style="position:absolute;top:570px;left:399px;white-space:nowrap" class="ft15">&#160;</p>
        <p style="position:absolute;top:570px;left:420px;white-space:nowrap" class="ft15">@if($samples[0]->brix != NULL) {{ number_format($samples[0]->brix, 2) }} @endif&#160;</p>
        <p style="position:absolute;top:570px;left:529px;white-space:nowrap" class="ft15">@if($samples[1]->brix != NULL) {{ number_format($samples[1]->brix, 2) }} @endif&#160;</p>
        <p style="position:absolute;top:570px;left:660px;white-space:nowrap" class="ft15">Brixwegger&#160;</p>
        ...
        <p style="position:absolute;top:591px;left:422px;white-space:nowrap" class="ft15">@if($samples[0]->tsai != NULL) {{ number_format($samples[0]->tsai, 2) }} @endif&#160;</p>
        <p style="position:absolute;top:591px;left:529px;white-space:nowrap" class="ft15">@if($samples[1]->tsai != NULL) {{ number_format($samples[1]->tsai, 2) }} @endif&#160;</p>
        <p style="position:absolute;top:591px;left:659px;white-space:nowrap" class="ft15">Lane-Eynon&#160;</p>
        <p style="position:absolute;top:612px;left:108px;white-space:nowrap" class="ft15">3&#160;</p>
        <p style="position:absolute;top:612px;left:200px;white-space:nowrap" class="ft15">OD&#160;</p>
        <p style="position:absolute;top:612px;left:336px;white-space:nowrap" class="ft15">-&#160;</p>
        <p style="position:absolute;top:612px;left:417px;white-space:nowrap" class="ft15">@if($samples[0]->od != NULL) {{ number_format($samples[0]->od, 2) }} @endif&#160;</p>
        <p style="position:absolute;top:612px;left:524px;white-space:nowrap" class="ft15">@if($samples[1]->od != NULL) {{ number_format($samples[1]->od, 2) }} @endif&#160;</p>
        <p style="position:absolute;top:612px;left:641px;white-space:nowrap" class="ft15">Spektrofotometri&#160;</p>
        ...
        <p style="position:absolute;top:952px;left:625px;white-space:nowrap" class="ft16">
            <b>&#160;&#160;&#160;&#160;&#160;&#160;M.&#160;Anas&#160;Mu’allif&#160;</b></p>
        ...
        <p style="position:absolute;top:976px;left:625px;white-space:nowrap" class="ft16">
            <b>&#160;&#160;</b>Kabag.&#160;Quality&#160;Control&#160;</p>
    </div>
</body>
