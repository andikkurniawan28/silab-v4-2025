...
@section('content')
    <div class="container-fluid py-0 px-0">
        <h1 class="h3 mb-3"><strong>Edit Jasa</strong></h1>
                ...
                <form action="{{ route('services.update', $service->id) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="code" id="code"
                            class="form-control @error('code') is-invalid @enderror" value="{{ old('code', $service->code) }}"
                            required>
                        @error('code')
                    ...
                    <div class="mb-3">
                        <label for="barcode" class="form-label">Barcode Jasa</label>
                        <input type="text" name="barcode" id="barcode"
                            class="form-control @error('barcode') is-invalid @enderror"
                            value="{{ old('barcode', $service->barcode) }}">
                        @error('barcode')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    {{-- Kategori --}}
                    {{-- <div class="mb-3">
                        <label for="service_category_id" class="form-label">Kategori Jasa</label>
                        <select name="service_category_id" id="service_category_id"
                            class="form-select select2 @error('service_category_id') is-invalid @enderror" required>
                    ...
                    <div class="row mb-3">
                            ...
                            <select name="main_unit_id" id="main_unit_id"
                                ...
                                @foreach ($units as $unit)
                                    <option value="{{ $unit->id }}"
                                        {{ old('main_unit_id', $service->main_unit_id) == $unit->id ? 'selected' : '' }}>
                                        {{ $unit->name }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        {{-- <div class="col-md-6">
                            ...
                            <select name="secondary_unit_id" id="secondary_unit_id"
                                ...
                                @foreach ($units as $unit)
                                    <option value="{{ $unit->id }}"
                                        {{ old('secondary_unit_id', $service->secondary_unit_id) == $unit->id ? 'selected' : '' }}>
                                        {{ $unit->name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    {{-- <div class="mb-3">
                        ...
                        <input type="number" step="0.01" id="conversion_rate" name="conversion_rate"
                            class="form-control" value="{{ old('conversion_rate', $service->conversion_rate) }}">
                    </div> --}}
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="purchase_price_main" name="purchase_price_main" class="form-control"
                                value="{{ old('purchase_price_main', $service->purchase_price_main) }}" required>
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" id="selling_price_main" name="selling_price_main" class="form-control"
                                value="{{ old('selling_price_main', $service->selling_price_main) }}">
                        </div>
                        {{-- <div class="col-md-6">
                            ...
                            <input type="text" id="purchase_price_secondary" name="purchase_price_secondary"
                                class="form-control"
                                value="{{ old('purchase_price_secondary', $service->purchase_price_secondary) }}">
                        </div> --}}
                    </div>
                    ...
                    {{-- <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="selling_price_secondary" name="selling_price_secondary"
                                ...
                                value="{{ old('selling_price_secondary', $service->selling_price_secondary) }}">
                        </div>
                    </div> --}}
