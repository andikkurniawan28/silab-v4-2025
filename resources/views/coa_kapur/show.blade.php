...
<style>
  ...
  .a4-container {
    ...
    margin: 20px auto;
    background-image: url('/admin_template/img/template_kop.jpg');
  ...
  <div class="a4-container">
    <div class="content">
      ...
      <div class="info-row">
        ...
        <div class="info-value">: @php echo formatTanggalIndonesia($request->tanggal_terima); @endphp</div>
      </div>
      <p class="info-subnote">Date of received</p>

      <div class="info-row">
        <div class="info-label">Tanggal Pengujian</div>
        <div class="info-value">: @php echo formatTanggalIndonesia($request->tanggal_pengujian); @endphp</div>
      </div>
      ...
      <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $dataX->material->name }}</td>
                <td>{{ $dataX->nopol }}</td>
                <td>
                    {{ is_numeric($dataX->p27) ? number_format($dataX->p27, 2) : '-' }}
                  </td>
                  <td>
                    {{ is_numeric($dataX->p34) ? number_format($dataX->p34, 2) : '-' }}
                </td>
                <td>
                    @if($dataX->p27 < 90)
                        {{ "Tidak Baik" }}
    ...
    <div style="width: 100%; text-align: right; margin-top: 60px; font-size: 16px; font-family: 'Times New Roman', Times, serif;">
        <p style="margin: 0;">Malang, @php echo formatTanggalIndonesia($request->tanggal_cetak); @endphp</p>
        <br><br><br><br><br><br>
