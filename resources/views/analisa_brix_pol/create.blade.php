...
@section('content')
    <div class="container-fluid py-0 px-0">
        <h1 class="h3 mb-3"><strong>Tambah Analisa Brix Pol</strong></h1>

        <div class="card shadow-sm">
            <div class="card-body">
                <form action="{{ route('analisa_brix_pol.store') }}" method="POST">
                    @csrf
                    ...
                    <a href="{{ route('analisa_brix_pol.index') }}" class="btn btn-secondary">
