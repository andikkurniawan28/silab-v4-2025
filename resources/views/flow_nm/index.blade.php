...
@section('content')
    <div class="container-fluid py-0 px-0">
        <h1 class="h3 mb-3"><strong>Daftar Flow NM</strong></h1>

        @if (Auth()->user()->role->akses_tambah_flow_nm)
            <div class="d-flex justify-content-between align-roles-center mb-3">
                <a href="{{ route('flow_nm.create') }}" class="btn btn-primary">
