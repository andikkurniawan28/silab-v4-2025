...
<head>
    ...
    <title>Print Jurnal - {{ $journal->code }}</title>
...
<body onload="window.print()">
    ...
    <div class="container my-4">
        <div class="header-title">
            <h3><strong>JURNAL AKUNTANSI</strong></h3>
        </div>

        <p><strong>Nomor Faktur:</strong> {{ $journal->code }}</p>
        <p>
        ...
        <div class="row mt-3">
            ...
            <div class="col-4 text-center">
                ...
                <div class="signature">
                    <br><br><br>
                    <p><strong>{{ $journal->user->name }}</strong></p>
                </div>
            </div>
        </div>
    </div>
