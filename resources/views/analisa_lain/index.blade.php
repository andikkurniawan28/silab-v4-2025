...
@section('content')
    <div class="container-fluid py-0 px-0">
        <h1 class="h3 mb-3"><strong>Daftar Analisa Lain</strong></h1>

        @if (Auth()->user()->role->akses_tambah_analisa_lain)
            <div class="d-flex justify-content-between align-roles-center mb-3">
                <a href="{{ route('analisa_lain.create') }}" class="btn btn-primary">
